...
help func------
*/
// int test_get_scale_float_num(float num) {
//     float fl_fract = 1.0;
//     float fl_int = 0.0;
//     fl_fract = modff(num, &fl_int);
//     int cnt = 0;
...
// START_TEST (converter_int_dec) {
//     int num = -12346969;
//     s21_decimal value_1;

//     for (; num < 12346969; num += 10) {
//         ck_assert_int_eq(0, s21_from_int_to_decimal(num, &value_1));
//         ck_assert_int_eq(num, value_1.bits[0]);
//     }
// } END_TEST;

// START_TEST (converter_dec_int) {
//     int num = 0;
//     s21_decimal value_1;

//     for (int i = -12346969; i < 12346969; i += 10) {
//         s21_from_int_to_decimal(i, &value_1);

//         ck_assert_int_eq(0, s21_from_decimal_to_int(value_1, &num));
//         ck_assert_int_eq(i, num);
//     }
// } END_TEST;

// START_TEST (converter_fl_dec) {
//     float num = -1234.123;
//     s21_decimal value_1;

//     for (; num < 1234.123; num += 0.1) {
//         ck_assert_int_eq(0, s21_from_float_to_decimal(num, &value_1));
//         ck_assert_int_eq(num, value_1.bits[0]);
//         ck_assert_int_eq(s21_get_scale(value_1),
//         test_get_scale_float_num(num));
//     }
// } END_TEST;

// START_TEST (converter_dec_float) {
//     float num = 0;
//     s21_decimal value_1;

//     for (float i = -1236.969; i < 1236.969; i += 0.1) {
//         s21_from_float_to_decimal(i, &value_1);

//         ck_assert_int_eq(0, s21_from_decimal_to_float(value_1, &num));
//         ck_assert_int_eq(i, num);
//     }
// } END_TEST;
...
START_TEST(test_s21_add_8) {
  s21_decimal test_value_1 = {{4294967295, 4294967295, 4294967295, 0}};
  s21_decimal test_value_2 = {{1, 1, 1, 0}};
  s21_set_bit(&test_value_1, 127);
  s21_set_bit(&test_value_2, 127);
  s21_decimal result_dec = {{0, 0, 0, 0}};
  int result = s21_add(test_value_1, test_value_2, &result_dec);
